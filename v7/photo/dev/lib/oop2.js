...
(function(){
	...
	Function.prototype.$defineProto = function(def){
		...
		this.$extendClass = this.$defineProto = this.$implements = function(){
			throw new Error("$defineProto 语句定义后面不能再作其它定义");
		};
		return this;
	};
	...
	Function.prototype.$extendClass = function(){
		var me = this;
		var i = arguments.length;
		var sup;
		var fn;
		if(i === 0){
			throw new Error("$extendClass 语句错误：未指定父类");
		}
		sup = arguments[0];
		fn = function(){
			var _this = this;
	...
	Function.prototype.$implements = function(){
		...
		this.$extendClass = function(){
			throw new Error("$extendClass 语句错误：$extendClass 语句不能出现在 $implements 定义之后");
		};
		return this;
	};
	...
	Function.prototype.$mixProto = function(){
		this.$extendClass = this.$defineProto = function(){
