...
Comment.Reply.prototype = {
    ...
    reply: function(id){
		...
		App.formInsertSmile("reply_txt", "reply_smile", null, inputTips, "reply_smile", arrPix);
     ...
     */
    post: function(){
        var inter = new Interface("http://control.blog.sina.com.cn/admin/comment/comment_reply_post.php?version=7", "ijax");
        var data = {};
...
//                trace("删除失败！请重试。");
    ...
    reply_struc: '\
		<!--<div class="SG_revert_Answer" id="reply_form">-->\
			<div class="SG_revert_Answer_Top">\
				...
				<span class="faceblk SG_floatR"><div id="reply_smile" class="faceline1"></div><div class="clearit"></div></span>\
			</div>\
			<div class="SG_revert_Answer_right">\
				<textarea class="SG_textarea" id="reply_txt"></textarea>\
				<div class="SG_revert_Btn">\
				<div class="SG_revert_Btn_left">\
					<span><a href="javascript:;" onclick="return false;" id="reply_btn" class="SG_aBtn"><cite>回复</cite></a></span>\
					<span><a href="javascript:;" onclick="return false;" id="reply_cancel" class="SG_aBtn"><cite>取消</cite></a></span>\
    ...
    reply_display_struc: '\
		<div class="SG_revert_Re SG_j_linedot1" id="reply_#{reply_id}">\
			<p>\
				<span class="SG_revert_Tit">博主回复：</span>\
				<span class="SG_revert_Time"><em class="SG_txtc">#{reply_time}</em>\
				<a onclick="return false;" href="#" class="CP_a_fuc">[<cite onclick="del_reply(#{reply_id})">删除</cite>]</a>\
				</span>\
			</p>\
