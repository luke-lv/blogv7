...
Comment.List.prototype = {
    ...
    load: function(page){
        this.page = page;
        var url = "http://blog.sina.com.cn/s/comment_" + this.articleid + "_" + this.page + ".html";
        var loader = new Interface(url, "ajax");
		var _this=this;
        loader.request({
            GET: {
                url_random: 0
...
//		trace('e='+data);
        if (data == "") {
            ...
            $E("article_comment_list").innerHTML = '<span name="' + this.defaultAnchor + this.page + '" id="'+this.defaultAnchor + this.page+'"></a>' + data;
        }
        this.anchor();
        this.paging();
    },
