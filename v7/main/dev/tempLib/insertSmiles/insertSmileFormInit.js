...
App.insertSmilesForm2.prototype = {
    ...
    renderUI: function () {
        ...
        for (var key in this.data) {
            ...
            if (count <= this.option.sortCount) {
                ...
                node.onmousedown = Core.Function.bind3(function (key) {
                    App.insertSmilesDialog2(key, __this.option.clickCallback, __this.option.positionNode, __this.option.arrPosPix);
                }, null, [key]);
                node.hideFocus = true;
                node.innerHTML = '<img src="http://www.sinaimg.cn/uc/myshow/blog/misc/gif/' + key + '-25.gif" alt="' + _title + '" title="' + _title + '" />';
        ...
        var _morelink = $C("a");
        _morelink.href = "#";
        _morelink.onclick = function () {
            Core.Events.stopEvent();
            return false;
        };
        _morelink.onmousedown = (function (ele) {
            return function () {
                App.insertSmilesDialog2(0, __this.option.clickCallback, __this.option.positionNode, __this.option.arrPosPix);
