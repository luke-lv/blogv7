 ...
 * 	});
    ...
    (function () {
        ...
        var swfobject = function () {
             ...
             */
            var ua = function () {
                var w3cdom = typeof doc.getElementById != UNDEF && typeof doc.getElementsByTagName != UNDEF && typeof doc.createElement != UNDEF, playerVersion = [0,
                        0, 0], d = null;
...
//		trace("\u6e05\u7406:: \u6e05\u7406\u5e76\u521d\u59cb\u5316\u6570\u636e", {color: "yellow"});
    ...
    var createSwf = function (sUID) {
        ...
        Sina.util.Swf.Add($_GLOBAL.flashBasicURL + "share_connect.swf", "webIM_Conn_Connect", "1", "1", "", "", "", {
...
//			console.log("UID\u4e0d\u4e00\u6837,\u4e0d\u4f7f\u7528\u51b7\u5374\u65f6\u95f4");
    ...
    webIM.conn_nick = function (sData) {
        ...
        sMSG = sMSG.replace(/(<|>| )/g, function (a, b) {
            switch (b) {
                case "<" :
                    return "&lt;";
                case ">" :
        ...
        var oarg = {
            ...
            callback: function () {
                //v6sendlog
                var o = new Image();
                o.src = "http://blog.sina.com.cn/main_v5/ria/ii.html?type=webuc&label=webim&parm=tips-open&" + new Date().valueOf();
    ...
    var webIM_Pop = function (opt) {
        ...
        //v6sendlog
        var o = new Image();
        o.src = "http://blog.sina.com.cn/main_v5/ria/ii.html?type=webuc&label=webim&parm=tips&" + new Date().valueOf();
