...
//            Ui.tween($E('topSetting'), ['opacity', 'marginTop'], [0.1, -408], 1, 'simple', {});
            ...
            _default.request({
                ...
                onSuccess: function (data) {
                    ...
                    window.location.href = "http://control.blog.sina.com.cn/myblog/htmlsource/index.php?uid=" + scope.$uid + "&status=pageset";
                },
...
//                    Ui.tween($E('topSetting'), ['opacity', 'marginTop'], [1, 0], 1, 'simple', {});
    ...
    window.guideJump = function () {
        winDialog.confirm("您即将离开本页进入页面设置，是否保存后再进入？“确定”表示保存后进入，“取消”表示直接进入。", {
            funcOk: function () {
                guideJumpSave();
            },
            funcCancel: function () {
