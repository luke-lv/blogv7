...
function qwery() {
    ...
    function interpret(whole, tag, idsAndClasses, wholeAttribute, attribute, qualifier, value, wholePseudo, pseudo,
                       wholePseudoVal, pseudoVal) {
        var i, m, k, o, classes
    ...
    var isAncestor = 'compareDocumentPosition' in html ? function (element, container) {
        ...
        , getAttr = function () {
            ...
            return ((e.innerHTML = '<a href="#x">x</a>') && e.firstChild.getAttribute('href') != '#x') ? function (e,
                                                                                                                   a) {
