 ...
 */
TweenStrategyEx = function (startValue, endValue, duration, motion) {
    ...
    this.__eventDispatcher = new Core.Events.EventDispatcher(this);
        ...
        start: function () {
            ...
            var me = this, t, sv = this.startValue, ev = this.endValue, d = this.duration, value = [], startTime = (new Date()).getTime();
