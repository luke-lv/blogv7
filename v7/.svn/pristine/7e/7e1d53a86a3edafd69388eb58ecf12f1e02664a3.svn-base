...
$registComp(106, {
    load: function() {
        Lib.checkAuthor();
        var cloneLink = ($isAdmin && scope.$pageid != 'profile_index') ? '' : '<div class="cloneLink"><a href="#" onclick="Lib.Component.clone(' + this.compId + ', ' + this.size + ');return false;" class="SG_comClone"><img alt="添加到我的博客" src="http://simg.sinajs.cn/blog7style/images/widget/add1.gif">添加到我的博客</a></div>';
        var innerHTML = '<div class="cloneWidget">' +
                '<div class="widget_yushu">' +
                '<p class="yushu_count" id="comp106_num"></p>' +
                '<div class="yushu_btn">' +
                '<a href="#" onclick="_$comp106_qifu();return false" class="yushu_btn1" title="我要祈福"></a>' +
                '<a href="http://gongyi.sina.com.cn/z/yushu/index.shtml" target="_blank" class="yushu_btn2" title="我要捐款"></a>' +
                '</div></div> ' + cloneLink + '</div>';
