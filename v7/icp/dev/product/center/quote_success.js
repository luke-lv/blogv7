		...
		this._dialog=winDialog.createCustomsDialog({
			content:['<div class="CP_layercon6">',		
						'<div class="turnBox">',
							...
							'</p>',
							'<ul>',
								'<li><span class="a">评论：</span><span class="b"><textarea id="#{txtMemo}" style="color:#c8c8c8;" cols="" rows="3" class="SG_textarea">'+this.memoNullText+'</textarea></span></li>',
								'<li>',
							...
							'<div class="butt">',
								...
								'<a target="_blank" href="http://blog.sina.com.cn/admin/advice/advice_list.php" class="link">改进建议</a>',
							'</div>',
						'</div>',
						'<div class="clearit"></div>',
					'</div>'].join("")});
