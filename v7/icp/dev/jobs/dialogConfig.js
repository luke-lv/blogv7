...
'<tbody>',
	'<tr>',
		...
		'<div id="#{content}" class="CP_layercon1">',	
			...
			'<div id="#{subText}" class="CP_w_cnt SG_txtb"></div>',
			'<p class="CP_w_btns">',
				'<a style="margin-left:-10px;" id="#{linkOk}" class="SG_aBtn SG_aBtnB" href="#" onclick="return false;"><cite id="#{btnOk}"> <span id="#{ok}"></span> </cite></a>',
				'<a style="margin-left:20px;" id="#{linkCancel}" class="SG_aBtn SG_aBtnB" href="#" onclick="return false;"><cite id="#{btnCancel}"> <span id="#{cancel}"></span> </cite></a></p>',
			'</div>',
		'</div>',
		'</td>',
		'<td class="tRight"><span></span></td>',
