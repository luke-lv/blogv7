 ...
 * @return {HTMLElement} el    源节点的前一个nodeType为1的节点，去除了#text、#comment
 */
Core.Dom.previousNode = function (srcEl) {
	return Core.Dom.findNode(srcEl, 'previousSibling', 'previousSibling');
};