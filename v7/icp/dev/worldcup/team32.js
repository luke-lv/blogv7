...
Team32Popup.prototype = {
	...
	resetTeam32 : function(){
		try{ Ui.tween.stop(this.fakeImg); }catch(e){  }		//阻止回调。
	...
	tweenPlay : function(){
		...
		new Ui.tween(
			this.fakeImg,
			["opacity", "height", "width", "right"],
			[0.6, this.entity.offsetHeight, this.entity.offsetWidth, 0],
			0.3,
			"strongEaseIn",
			{end : function(){		//播放完毕，显示节点，然后自己隐身。
	...
	'<div class="worldcup_layer01_bg"></div>',
	'<div class="worldcup_layer01">',
		'<div class="worldcup_layer01_tit">请选择你喜欢的国家队：</div>',
	    '<div class="worldcup_layer01_list">',
	    	'<div class="worldcup_layer01_group">',
	        	'<div class="worldcup_layer01_gt">A组</div>',
	            '<ul>',
	        ...
	        '</div>',
	        '<div class="worldcup_layer01_group">',
	        	'<div class="worldcup_layer01_gt">B组</div>',
	            '<ul>',
	        ...
	        '</div>',
	        '<div class="worldcup_layer01_group">',
	        	'<div class="worldcup_layer01_gt">C组</div>',
	            '<ul>',
	        ...
	        '</div>',
	        '<div class="worldcup_layer01_group">',
	        	'<div class="worldcup_layer01_gt">D组</div>',
	            '<ul>',
	        ...
	        '</div>',
	        '<div class="worldcup_layer01_group">',
	        	'<div class="worldcup_layer01_gt">E组</div>',
	            '<ul>',
	        ...
	        '</div>',
	        '<div class="worldcup_layer01_group">',
	        	'<div class="worldcup_layer01_gt">F组</div>',
	            '<ul>',
	        ...
	        '</div>',
	        '<div class="worldcup_layer01_group">',
	        	'<div class="worldcup_layer01_gt">G组</div>',
	            '<ul>',
	        ...
	        '</div>',
	        '<div class="worldcup_layer01_group">',
	        	'<div class="worldcup_layer01_gt">H组</div>',
	            '<ul>',
