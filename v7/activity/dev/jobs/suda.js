...
$registJob("suda", function (){
	var suda_flag = scope && scope.$pageid && scope.$pageid === 'tbhShow' && scope.$pageid === '365energy';
	...
	if (suda_flag) {//请求调用
		switch (scope.$pageid){
			case "tbhShow": v7sendLog('42_01_20'); break;	//淘博会 http://blog.sina.com.cn/lm/ishopping.html
			case "365energy": v7sendLog('42_01_32'); break;	//365正能量 http://blog.sina.com.cn/lm/i365day1.html
		}
	}
    Lib.sendSuda(function () {
        ...
        if(suda_flag){
            switch (scope.$pageid){
                case "tbhShow": v7sendLog('42_01_21'); break;
                case "365energy": v7sendLog('42_01_33'); break;
            }
        }
    });	
