/**
 * @fileoverview 透明度渐变的呈现类,实现了IRenderer接口
...
Ui.OpacityRenderer=function(){
	...
	show:function(node){
		var tn=this.__tween;
		tn.stop();
		Core.Dom.setStyle(node,"opacity",this.__value);
		node.style.display="";
		this.__node=node;
		this.__state="show";
