...
$registJob("gotoTop", function(){
    ...
    //创建回到顶部元素
    var parent = Core.Dom.getElementsByClass(document.body, 'div', 'footer');
    ...
    var lastNode = Core.Dom.getElementsByClass(document.body, 'div', 'side5'),
        lastNode = lastNode && lastNode[0],
